...
// Arcane-FX
//    Changes:
//        zodiacs -- Changes made for rendering afx zodiacs on terrain. 
//
//    The AFX terrain implementation of zodiacs is largely contained in
//    afxZodiac.[h,cc], however, some changes are required to the terrain
//    code. Structures EmitNode and SquareStackNode now contain an
...
struct TerrainRender
{
   ...
   // AFX CODE BLOCK (zodiacs) <<
   static void emitTerrChunk(SquareStackNode *n, F32 squareDistance, U32 lightMask, bool farClip, bool useDetails, bool useBumps, afxZodiacBitmask zodiacMask);
   /* ORIGINAL CODE
