...
{
  raycastMouse(evt);	// DARREN MOD: mouse click movement
}
...
void afxTSCtrl::raycastMouse(const GuiEvent &evt)
{
  MatrixF cam_xfm;
  Point3F dummy_pt;
  ...
  {      
    ...
    {         
      ...
      arcaneFX::rolloverRayCast(cameraPoint, rangeEnd, arcaneFX::sTargetSelectionMask, arcaneFX::sDestinationMask);
    }   
  }
}
