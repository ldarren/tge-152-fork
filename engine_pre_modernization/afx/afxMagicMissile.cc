...
#ifdef AFX_TGE_1_3
  Con::registerType("AfxMagicMissileDataPtr", TypeafxMagicMissileDataPtr, sizeof(afxMagicMissileData*),
                    REF_GETDATATYPE(afxMagicMissileData), REF_SETDATATYPE(afxMagicMissileData));
#endif
