...
class SimObject: public ConsoleObject
{
  ...
  private:
   ...
   enum {
	  ...
	  HighLighted = BIT(8)			///< This object has been picked by mouse cursor in game, mod for object selection additions
   };
  public:
   /// @name Notification
   /// @{
...
protected:
  ...
  public:
   ...
   bool isHighLighted() const { return mFlags.test(HighLighted); } // object selection additions
   ...
   void setHighLighted(bool hi) { if (hi) mFlags.set(HighLighted); else mFlags.clear(HighLighted); } // object selection additions
