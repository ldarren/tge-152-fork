...
public:
   enum PublicConstants {
	  ...
	  MaxSkinModifiers = 6            ///< Dynamic_Skin_Modifiers. Maximum allowed slots for skin modifiers
   };
...
public:
   ...
   enum ShapeBaseMasks {
	  ...
	  SoundMaskN      = Parent::NextFreeMask << 9,       ///< Extends + MaxSoundThreads bits. original: 8
