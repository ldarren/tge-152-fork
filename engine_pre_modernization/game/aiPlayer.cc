...
// DARREN MOD: mouse click movement, make movement smoother? edited: no, become worse
ConsoleMethod( AIPlayer, setMoveTolerance, void, 3, 3, "(float tolerance)" "Sets the movetolerance")
{
...
{
   const Point3F & movePoint = object->getMoveDestination();
...
void AIPlayer::restartMove(U32 tag, bool is_death_anim)
{
