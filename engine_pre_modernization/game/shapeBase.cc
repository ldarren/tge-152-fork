...
U32 ShapeBase::packUpdate(NetConnection *con, U32 mask, BitStream *stream)
{
   ...
   if(!stream->writeFlag(mask & (NameMask | DamageMask | SoundMask |
         ...
         ShieldMask | SkinMask | SkinMaskMod))) // Dynamic_Skin_Modifiers. added SkinMaskMod
      return retMask;
   ...
   if (stream->writeFlag(mask & (NameMask | ShieldMask | CloakMask | InvincibleMask | SkinMask | SkinMaskMod))) { // Dynamic_Skin_Modifiers added SkinMaskMod
...
ConsoleMethod(ShapeBase, addSkinModifier, bool, 5, 10, "(U32 slot, string skinLocation, string skinName, string maskName, ColorI color1 [,color2,3,4='']) Add a skin modifier.")
{
