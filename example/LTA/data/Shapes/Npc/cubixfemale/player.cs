...
datablock TSShapeConstructor(PlayerDtsFemale)
{
   baseShape = "./player.dts";
  
   sequence0 = "./weapon_root.dsq root";
   sequence1 = "./weapon_forward.dsq run";
   sequence2 = "./weapon_back.dsq back";
   sequence3 = "./weapon_side.dsq side";
   sequence4 = "./weapon_jump.dsq jump";
   sequence5 = "./weapon_fall.dsq fall";
   sequence6 = "./weapon_land.dsq land";
   sequence7 = "./weapon_standjump.dsq standjump";
