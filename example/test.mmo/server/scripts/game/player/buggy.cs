...
{
   filename    = "~/data/sound/buggy/engine_idle.wav";
...
{
   textureName          = "~/data/shapes/vehicles/buggy/dustParticle";
   dragCoefficient      = 2.0;
...
datablock WheeledVehicleTire(DefaultCarTire)
{
   ...
   shapeFile = "~/data/shapes/vehicles/buggy/wheel.dts";
   staticFriction = 4.2;
...
{
   category = "Vehicles";
   shapeFile = "~/data/shapes/vehicles/buggy/buggy.dts";
   emap = true;
