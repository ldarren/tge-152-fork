...
new GuiControlProfile (GameGuiButtonProfile : GuiButtonProfile)
{
	soundButtonOver = "GameButtonHoverAudio";
	soundButtonDown = "GameButtonDownAudio";
};

if(!isObject(GameGuiCheckboxProfile)) new GuiControlProfile (GameGuiCheckboxProfile : GuiCheckBoxProfile)
{
	bitmap = "./pictures/buttons/RadioButton";
	hasBitmapArray = true;
	opaque=false;
	border=false;
	soundButtonDown = "GameCheckDownAudio";
};

if(!isObject(GameGuiRadioProfile)) new GuiControlProfile (GameGuiRadioProfile : GuiRadioProfile)
{
	bitmap = "./pictures/buttons/RadioButton";
	hasBitmapArray = true;
	opaque=false;
...
if(!isObject(GameGuiProgressProfile)) new GuiControlProfile (GameGuiProgressProfile : GuiProgressProfile)
{
   opaque = true;
...
if(!isObject(GameGuiScrollProfile))  new GuiControlProfile (GameGuiScrollProfile)
{
   opaque = true;
...
if(!isObject(GameGuiTextListProfile)) new GuiControlProfile (GameGuiTextListProfile)
{
   opaque = true;
