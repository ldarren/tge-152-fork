...
function initClient()
{
	...
	$Client::SavedFileLocation = $modname@"/data/saves/";
	$saveInfo::mission = "";
	...
	//fileEncDec("~/data/dialogs/dlq/question.txt", "~/data/dialogs/dlq/q005.dlq");
	//fileEncDec("~/data/dialogs/dlq/q005.dlq", "~/data/dialogs/dlq/q006.txt");
