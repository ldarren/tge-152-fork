...
{
   strikeTextures[0]  = $modname@"/data/environment/lightning1frame1";
   strikeTextures[1]  = $modname@"/data/environment/lightning1frame2";
   strikeTextures[2]  = $modname@"/data/environment/lightning1frame3";
