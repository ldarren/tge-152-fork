...
function GetCharName(%index)
{
    return $Avatar.id[%index];
}

function OptPlayerMenu::init( %this )
{
	%this.clear();
    ...
    %this.setSelected( %this.findText($Pref::Player::Character) );
    %this.setText($Pref::Player::Character);
}

function optionsDlg::applyPlayer( %this )
{
	%PlayerCharacter = OptPlayerMenu.getText();
    $Pref::Player::Character = %PlayerCharacter;
    OptPlayerMenu.setSelected( %this.findText($Pref::Player::Character));
    OptPlayerMenu.setText($Pref::Player::Character);
}

function clientCmdGetPlayerCharacter(%this)
{
    commandToServer('SetPlayerCharacter',$Pref::Player::Character);
}
...
$RemapCount++;
$RemapName[$RemapCount] = "Shielding";
$RemapCmd[$RemapCount] = "altTrigger";
$RemapCount++;
//$RemapName[$RemapCount] = "Toggle Ruler";
//$RemapCmd[$RemapCount] = "useRuler";
//$RemapCount++;
//$RemapName[$RemapCount] = "Toggle Pillow";
//$RemapCmd[$RemapCount] = "usePillow";
//$RemapCount++;
//$RemapName[$RemapCount] = "Toggle Plunger";
//$RemapCmd[$RemapCount] = "usePlunger";
//$RemapCount++;
//$RemapName[$RemapCount] = "Toggle Light Saber";
//$RemapCmd[$RemapCount] = "useSword";
//$RemapCount++;
//$RemapName[$RemapCount] = "Toggle Axe";
//$RemapCmd[$RemapCount] = "useAxe";
//$RemapCount++;
//$RemapName[$RemapCount] = "Toggle CDROM";
//$RemapCmd[$RemapCount] = "useCrossbow";
//$RemapCount++;
...
$RemapCount++;
$RemapName[$RemapCount] = "Animation - Taunt";
