...
*/
datablock AudioProfile(PlungerFireSound)
{
	filename = "~/data/sound/plungerFire.wav";
	description = AudioClose3d;
	preload = true;
};
/*
...
datablock ItemData(Plunger)
{
   ...
   shapeFile = "~/data/shapes/sword/plunger.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
...
datablock ShapeBaseImageData(PlungerImage)
{
   ...
   //hthNumAttacks = 3;
   hthAttack[0]                     = PlungerOneHandedAttackSlice;
   hthAttack[1]                     = PlungerOneHandedAttackSwing;
   //hthAttack[2]                     = OneHandedAttackThrust;
	hthAttack[2]                     = PlungerOneHandedJumpAttack;
