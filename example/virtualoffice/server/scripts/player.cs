...
datablock PlayerData(PlayerBody)
{
   ...
   maxInv[BulletAmmo]   = 99999999999999;
   maxInv[HealthKit]    = 1;
...
function Armor::damage(%this, %obj, %sourceObject, %position, %damage, %damageType)
{
   if (%obj.getState() $= "Dead")
	...
	%tmpDamage = %damage * %attacker.player.getDamageMod();
   %obj.applyDamage(%tmpDamage);
...
function Armor::onDisabled(%this,%obj,%state)
{
   ...
   commandToClient(%obj.client, 'SetWeaponGUI', "Ruler");
