...
*/
datablock AudioProfile(AxeFireSound)
{
	filename = "~/data/sound/axeFire.wav";
	description = AudioClose3d;
	preload = true;
};
/*
...
datablock ItemData(Axe)
{
   ...
   shapeFile = "~/data/shapes/sword/axe.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
...
datablock ShapeBaseImageData(AxeImage)
{
   ...
   //hthNumAttacks = 3;
   hthAttack[0]                     = AxeOneHandedAttackSlice;
   hthAttack[1]                     = AxeOneHandedAttackSwing;
   //hthAttack[2]                     = OneHandedAttackThrust;
	hthAttack[2]                     = AxeOneHandedJumpAttack;
