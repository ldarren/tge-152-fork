...
*/
datablock AudioProfile(RulerFireSound)
{
	filename = "~/data/sound/rulerFire.wav";
	description = AudioClose3d;
	preload = true;
};
/*
...
datablock ItemData(Ruler)
{
   ...
   shapeFile = "~/data/shapes/sword/ruler.dts";
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   emap = true;
...
// phdana hth ->
datablock ShapeBaseImageData(RulerImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/sword/ruler.dts";
   emap = true;
   ...
   //hthNumAttacks = 3;
   hthAttack[0]                     = RulerOneHandedAttackSlice;
   hthAttack[1]                     = RulerOneHandedAttackSwing;
   //hthAttack[2]                     = OneHandedAttackThrust;
	hthAttack[2]                     = RulerOneHandedJumpAttack;
...
function RulerImage::onFire(%this, %obj, %slot)
{
