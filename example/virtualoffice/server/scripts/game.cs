...
function GameConnection::onDeath(%this, %sourceObject, %sourceClient, %damageType, %damLoc)
{
   ...
   if (%damageType $= "Suicide" || %sourceClient == %this) {
		%sourceClient = %sourceObject ? %sourceObject.client : %this;
...
{
	//commandToClient(%this, 'GetPlayerCharacter');//"PlayerBody";
...
function GameConnection::createPlayer(%this, %spawnPoint, %PlayerCharacter)
{
   if (%this.player > 0)  {
	...
	//TEMPORARY BEFORE GUI FIX
    //%BodyData = %PlayerCharacter@"Body";
	%BodyData = "PlayerBody"; 
   ...
   // Starting equipment
   //%player.setInventory(Ruler,1);
   //%player.mountImage(RulerImage,0);
	//%player.setInventory(Crossbow,1);
   //%player.setInventory(CrossbowAmmo,20);
	//commandToClient(%this, 'SetWeaponGUI', "Ruler");
