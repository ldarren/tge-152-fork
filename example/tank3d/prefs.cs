...
$pref::CloudsOn = "1";
$pref::Constructor::lastPath = "creator/terrain_imports";
...
$Pref::Server::ConnectionError = "You do not have the correct version of the Tank Attack 3D Game Engine or the related art needed to connect to this server, please contact the server operator to obtain the latest version of this game.";
