...
datablock TSShapeConstructor(PlayerDts1)
{
   baseShape = "~/data/shapes/tank01/player1.dts";
...
datablock PlayerData(PlayerShape1 : PlayerShape)
{
   renderFirstPerson = false;
   shapeFile = "~/data/shapes/tank01/player1.dts";
   computeCRC = true;
...
function PlayerShape1::onAdd(%this,%obj)
{
...
function PlayerShape1::onRemove(%this, %obj)
{
   if (%obj.client.player == %obj)
      %obj.client.player = 0;
}

function PlayerShape1::onNewDataBlock(%this,%obj)
{
