...
datablock TSShapeConstructor(PlayerDts3)
{
   baseShape = "~/data/shapes/tank03/player3.dts";
   sequence0 = "~/data/shapes/tank03/Root3.dsq root";
	sequence1 = "~/data/shapes/tank03/recoilde3.dsq light_recoil";
...
datablock PlayerData(PlayerShape3 : PlayerShape)
{
   renderFirstPerson = false;
   shapeFile = "~/data/shapes/tank03/player3.dts";
   computeCRC = true;
...
function PlayerShape3::onAdd(%this,%obj)
{
...
function PlayerShape3::onRemove(%this, %obj)
{
   if (%obj.client.player == %obj)
      %obj.client.player = 0;
}

function PlayerShape3::onNewDataBlock(%this,%obj)
{
