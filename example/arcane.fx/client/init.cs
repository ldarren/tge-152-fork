...
function initClient()
{
   echo("\n--------- Initializing MOD: ArcaneFX DEMO: Client ---------");

   // Make sure this variable reflects the correct state.
   $Server::Dedicated = false;

   // Game information used to query the master server
   $Client::GameTypeQuery = "ArcaneFX DEMO";
   ...
   // load time.
   initCanvas("AFX 1.1 for TGE 1.5.2 -- AFX Demo ", true);
   if (!isObject(Canvas))
   ...
   exec("./scripts/afxSelectionMgr.cs");
