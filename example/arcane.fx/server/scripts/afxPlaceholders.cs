...
datablock afxRPGMagicSpellData(CK_Placeholder_RPG)
{
  ...
  desc = "This icy preview spell is currently unavailable.";
  iconBitmap = "~/data/effects/icons/ck";
  sourcePack = $PREVIEW;
  isPlaceholder = true;
};
...
addDemoSpellbookPlaceholder(PCO_Placeholder_RPG,   1, 6);
addDemoSpellbookPlaceholder(PHYZ_Placeholder_RPG,  1, 7);
addDemoSpellbookPlaceholder(TF_Placeholder_RPG,    1, 8);
addDemoSpellbookPlaceholder(TAF_Placeholder_RPG,   1, 10);
...
// PREVIEW SPELLBANK
addDemoSpellbookPlaceholder(CK_Placeholder_RPG,   3, 0);
