...
$Pref::Server::Name = "Arcane-FX Demo"; // AFX
$Pref::Server::Info = "This is an Arcane-FX Demo server."; // AFX
...
$Pref::Server::ConnectionError =
   "You do not have the correct version of the Arcane-FX Demo or "@   // AFX
