...
addMaterialMapping("Wall_filler101m" , "detail: modernization.fps/data/interiors/lightingPack/wall_detail"); 
...
datablock DecalData(GlowDecal)
{
   sizeX       = 2;
   sizeY       = 2;
   textureName = "modernization.fps/data/shapes/lightingPack/Arrow";
...
{
  animateTexture = "0";
  animTexName[0] = "modernization.fps/data/shapes/particles/smoke";
  ...
  spinRandomMin = "-100";
  spinSpeed = "0.29";
  textureName = "modernization.fps/data/shapes/particles/smoke";
  times[0] = "0";
  times[1] = "0.49";
  times[2] = "1";
  times[3] = "1";
