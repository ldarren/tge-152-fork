...
*/
	...
	//Declare constants
	const int mapWidth = 64, mapHeight = 48, tileSize = 10, numberPeople = 3;
	int onClosedList = 10;
	const int notfinished = 0, notStarted = 0;// path-related constants
	const int found = 1, nonexistent = 2; 
	const char walkable = 0, unwalkable = 1;// walkability array constants
//	const char DirectionLeft =4, DirectionRight=6;DirectionUp=8,DirectionDown=2,DirectionDownLeft=1,DirectionDownRight=3,DirectionUpLeft=7,DirectionUpRight=9; //Direction of path travel
...
// 		whether a cell is on the open list or on the closed list.
	...
	//int WalkingDirection[mapWidth*mapHeight+2];	//1d array to store direction of travel
...
//	Repeat the following until the new item in slot #1 sinks to its proper spot in the heap.
	...
	//changed to prevent stopping of process
