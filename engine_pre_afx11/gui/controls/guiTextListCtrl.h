...
// Header MOD, 2008 Feb 12, based on this reource http://www.garagegames.com/index.php?sec=mg&mod=resource&page=view&qid=14209
//-----------------------------------------------------------------------------
...
class GuiTextListCtrl : public GuiArrayCtrl
{
  ...
  public:
   ...
   // Header MOD start
   virtual void addHeader(const char *text);
