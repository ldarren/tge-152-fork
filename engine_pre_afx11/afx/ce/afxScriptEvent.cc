...
#ifdef AFX_TGE_1_3
  Con::registerType("AfxScriptEventDataPtr", TypeAfxScriptEventDataPtr, sizeof(afxScriptEventData*), 
                    REF_GETDATATYPE(afxScriptEventData), REF_SETDATATYPE(afxScriptEventData));
#endif
