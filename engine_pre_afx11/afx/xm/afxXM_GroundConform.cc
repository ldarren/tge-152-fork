...
public:
  /*C*/         afxXM_GroundConform(afxXM_GroundConformData*, afxEffectWrapper*);
...
afxXM_Base* afxXM_GroundConformData::create(afxEffectWrapper* fx)
{
  return new afxXM_GroundConform(this, fx);
}

//~~~~~~~~~~~~~~~~~~~~//~~~~~~~~~~~~~~~~~~~~//

afxXM_GroundConform::afxXM_GroundConform(afxXM_GroundConformData* db, afxEffectWrapper* fxw) 
