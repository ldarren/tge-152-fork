...
#ifdef AFX_TGE_1_3
  Con::registerType("AfxRPGMagicSpellData", TypeafxRPGMagicSpellData, sizeof(afxRPGMagicSpellData*),
                    REF_GETDATATYPE(afxRPGMagicSpellData), REF_SETDATATYPE(afxRPGMagicSpellData));
#endif
