...
public:
  ...
  enum 
  {
    ...
    //
    INTERIOR_VERT_IGNORE    = BIT(10),
    INTERIOR_HORIZ_ONLY     = BIT(11),
    INTERIOR_BACK_IGNORE    = BIT(12),
    INTERIOR_OPAQUE_IGNORE  = BIT(13),
    INTERIOR_TRANSP_IGNORE  = BIT(14),
    INTERIOR_FILTERS = INTERIOR_VERT_IGNORE | INTERIOR_HORIZ_ONLY | INTERIOR_BACK_IGNORE | INTERIOR_OPAQUE_IGNORE | INTERIOR_TRANSP_IGNORE
  };
};
