...
void afxChoreographerData::gather_cons_defs(Vector<afxConstraintDef>& defs, afxEffectList& fx)
{
...
bool afxChoreographer::addConstraint(const char* object_name, const char* cons_name)
{
  ...
  S32 args_n = dSscanf(object_name, "%g %g %g %g %g %g %g", 
                       &pos.x, &pos.y, &pos.z,
                       &aa.axis.x, &aa.axis.y, &aa.axis.z, &aa.angle);
