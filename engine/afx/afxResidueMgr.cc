...
void afxResidueMgr::manage_residue(const Residue* r)
{
  ...
  if (r->type == ZODIAC)
  {
    ...
    afxZodiacMgr::addZodiac(zode_pos, r->params.zodiac.rad, zode_vrange, zode_color, r->params.zodiac.ang, 
                            &zd->txr, zd->zflags);
  }
...
void afxResidueMgr::add(F32 dur, F32 fade_dur, afxZodiacData* zode, const Point3F& pos,
