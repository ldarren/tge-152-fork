...
protected:
   ...
   struct ActionAnimation {
      ...
      bool atEnd;
	  bool forceSet; // DARREN MOD: 
	  bool locked; // DARREN MOD: disable or lock this thread
   } mActionAnimation;
...
public:
   ...
   bool setActionThread(const char* sequence,bool hold,bool wait,bool fsp = false,bool forceSet=false);
...
public:
   ...
   // DARREN MOD: disable action thread totally
public:
   void         unlockActionThread();
   void          lockActionThread();
