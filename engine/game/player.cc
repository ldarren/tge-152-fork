...
Player::Player()
{
   ...
   mActionAnimation.locked = false; // DARREN MOD: lock action thread
   mActionAnimation.forceSet = false; // DARREN MOD: ignore action thread schedule
   mState = MoveState;
   mFalling = false;
   mContactTimer = 0;
   mJumpDelay = 0;
