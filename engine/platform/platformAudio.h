...
- Added alx function to stop all except streaming (music) sources.
...
void alxStopAll();
void alxStopAllExceptStreaming();  // <-- MMO Kit
...
ALbyte * alxGetOutputFFT(S32 band, ALbyte * buffer); // DARREN MOD: Audio Visualization
